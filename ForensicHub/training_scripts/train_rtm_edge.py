...
def main(args, model_args, train_dataset_args, test_dataset_args, transform_args, evaluator_args):
    ...
    test_dataset_list = {}
    test_dataset_list['RTM_Test'] = OthersData('/mnt/data0/public_datasets/Doc/cutted_datasets_fakes/RealTextManipulation_test', train=False,crop_test=False,edge_width=7)
    test_sampler = {}
    if args.distributed:
