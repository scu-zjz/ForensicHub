...
def main(args, model_args, train_dataset_args, test_dataset_args, transform_args, evaluator_args):
    ...
    use_dct=False
    train_dataset = DocTamperDataOrigin('/mnt/data0/public_datasets/Doc/DocTamperV1/DocTamperV1-TrainingSet', train=True, use_dct=use_dct)
    test_dataset_list = {}
    test_dataset_list['DocTamperOriginTest'] = DocTamperDataOrigin('/mnt/data0/public_datasets/Doc/DocTamperV1/DocTamperV1-TestingSet', train=False, use_dct=use_dct)
    test_dataset_list['DocTamperOriginFCD'] = DocTamperDataOrigin('/mnt/data0/public_datasets/Doc/DocTamperV1/DocTamperV1-FCD', train=False, use_dct=use_dct)
    test_dataset_list['DocTamperOriginSCD'] = DocTamperDataOrigin('/mnt/data0/public_datasets/Doc/DocTamperV1/DocTamperV1-SCD', train=False, use_dct=use_dct)
    test_sampler = {}
    if args.distributed:
