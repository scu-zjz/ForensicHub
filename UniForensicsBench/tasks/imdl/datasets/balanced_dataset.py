...
from UniForensicsBench.registry import register_dataset
from UniForensicsBench.registry import DATASETS

@register_dataset("BalancedDataset")
class BalancedDataset(BaseDataset):
    ...
    def __init__(self,
        ...
        self.dataset_list = [self._get_dataset(path, dataset_type, *args, **kwargs) for path, dataset_type in
                             self.settings_list]
