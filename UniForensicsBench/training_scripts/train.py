...
import UniForensicsBench.training_scripts.utils.misc as misc
from UniForensicsBench.registry import DATASETS, MODELS, POSTFUNCS, TRANSFORMS, build_from_registry
from UniForensicsBench.common.evaluation import PixelF1, ImageF1
from UniForensicsBench.training_scripts.tester import test_one_epoch
from UniForensicsBench.training_scripts.trainer import train_one_epoch
from UniForensicsBench.common.utils.yaml import load_yaml_config, split_config, add_attr


def get_args_parser():
    parser = argparse.ArgumentParser('UniForensics benchmark training launch!', add_help=True)
